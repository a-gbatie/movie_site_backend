...
c1 = Comment.create(comments: "The Lion King is the G.O.A.T!!!", movie_id: 1, user_id: 2)
c2 = Comment.create(comments: ["Toy Story will always have a special place in my heart.", "Quick! Andy's coming!", "Woody's makeover in Toy Story 2, is my all time favorite scene."], movie_id: 2, user_id: 1)
c3 = Comment.create(comments: "Let's hope we don't have to wait another 14 years for The Incredibles 3, if they make one.", movie_id: 3, user_id: 3)
